        ...
        <div class="col">
            <div class="card" style="width: 215px;border:none">
                ...
                <div class="text-center">
                    <a href="{{ route('unsurpdp.index') }}" class="btn btn-primary" style="width: 174px; height:48px; margin-top: -70px;border-radius:10px  ">Pendidikan</a>
                </div>
              </div>
        </div>
        <div class="col">
    ...
    <div class="row">
        <div class="col">
            <div class="card" style="width: 215px;border:none">
                ...
                <div class="text-center">
                    <a href="#" class="btn btn-primary" style="width: 174px; height:48px; margin-top: -70px;border-radius:10px  ">Pendidikan</a>
                </div>
